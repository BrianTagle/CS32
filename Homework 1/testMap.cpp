...
int main()
{
	...
	assert(m.get(0, k, v) && k == "xyz" && v == 9876.5); //since "abc" was erased, everything was moved down by one
	assert(m.get(1, k, v) && k == "def" && v == 45.6); //since "abc" was erased, everything was moved down by one
	assert(m.get(2, k, v) && k == "ghi" && v == 7.89); //since "abc" was erased, everything was moved down by one
	assert(m.get(3, k, v) && k == "jkl" && v == 1.23); //since "abc" was erased, everything was moved down by one
